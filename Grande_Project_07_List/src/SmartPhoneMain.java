...
public class SmartPhoneMain {
	...
	public static void main(String[] args) {
		...
		for(int i=0; i<1; i++) {
			smartphonelist.addContact(smartphonelist.inputContactData(0));
		}
		while(true) {
			printMenu();
			...
			if(choiceMenu.equals("1")) {
				...
				if((choiceGroup == 1) || (choiceGroup == 2)) {
					smartphonelist.addContact(smartphonelist.inputContactData(choiceGroup));
				} else {
